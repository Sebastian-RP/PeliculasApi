...
namespace PeliculasApi.Controllers
{
    ...
    public class GenerosController : ControllerBase
    {
        ...
        public async Task<ActionResult> Post([FromBody] GeneroCreacionDTO generoCreacionDTO)
        {
            ...
            var generoDTO = mapper.Map<GeneroDTO>(entidad);//al haber interactuado con el contexto de la BD sabe que valor corresponde al Id
        ...
        {
            var existe = await context.Generos.AnyAsync(genero => genero.Id == id);
